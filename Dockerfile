...
# docker build -t jomo_karuta_typing_app .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name jomo_karuta_typing_app jomo_karuta_typing_app
